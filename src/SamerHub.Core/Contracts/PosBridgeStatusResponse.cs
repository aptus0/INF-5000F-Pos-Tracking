...
public sealed class PosBridgeStatusResponse
{
    ...
    public IReadOnlyList<string> AvailableTransactionTypes { get; set; } = [];
    public IReadOnlyList<string> AvailablePaymentMeans { get; set; } = [];
}
